...
Application::createGraphicsPipeline() {
    ...
    layoutCreateInfo.pSetLayouts = &descriptorSetLayout; // Array of descriotor set layout, Order matter when more than 1
...
void
Application::throwErrorAndExit(std::string error){
